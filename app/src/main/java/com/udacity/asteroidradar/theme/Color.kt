...
val md_theme_light_error = Color(0xFFC62D1F)
val md_theme_light_errorContainer = Color(0xFF99231B)
...
val md_theme_dark_error = Color(0xFFFFB4AB)             // Lighter error (M3 convention)
val md_theme_dark_errorContainer = Color(0xFF93000A)    // Dark error container
val md_theme_dark_onError = Color(0xFF690005)           // Dark text on error
val md_theme_dark_onErrorContainer = Color(0xFFFFDAD6)  // Light text on error container
